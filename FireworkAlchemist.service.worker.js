...
/** @type {string} */
const CACHE_VERSION = '1731477256|3146169436';
/** @type {string} */
const CACHE_PREFIX = 'FireworkAlchemis-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'FireworkAlchemist.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["FireworkAlchemist.html","FireworkAlchemist.js","FireworkAlchemist.offline.html","FireworkAlchemist.icon.png","FireworkAlchemist.apple-touch-icon.png","FireworkAlchemist.worker.js","FireworkAlchemist.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["FireworkAlchemist.wasm","FireworkAlchemist.pck"];
